 ...
 * Slug: ishop/product-search-results
 * Categories: hidden
 * Inserter: no
 */
?>
...
<h4 class="wp-block-heading has-medium-font-size" style="font-style:normal;font-weight:400"><?php esc_html_e('Categories', 'ishop');?></h4>
<!-- /wp:heading -->
...
<h4 class="wp-block-heading has-extra-small-font-size"><?php esc_html_e('Filter by price', 'ishop');?></h4>
<!-- /wp:heading -->
...
<div class="wp-block-woocommerce-filter-wrapper"><!-- wp:heading {"level":4,"fontSize":"extra-small"} -->
<h4 class="wp-block-heading has-extra-small-font-size"><?php esc_html_e('Filter by attribute', 'ishop');?></h4>
<!-- /wp:heading -->
...
<h2 class="wp-block-heading has-text-align-center has-x-large-font-size" style="font-style:normal;font-weight:700"><?php esc_html_e('No result', 'ishop');?></h2>
<!-- /wp:heading -->

<!-- wp:paragraph {"align":"center","fontSize":"medium"} -->
<p class="has-text-align-center has-medium-font-size"><?php esc_html_e('Check out this week\'s popular products', 'ishop');?></p>
<!-- /wp:paragraph --></div>
<!-- /wp:column -->
