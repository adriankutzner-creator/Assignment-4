 ...
 * Slug: ishop/taxonomy-product_attribute
 * Categories: hidden
 * Inserter: no
 */
?>
...
<h2 class="wp-block-heading has-small-font-size" style="font-style:normal;font-weight:400"><?php esc_html_e('Categories', 'ishop');?></h2>
<!-- /wp:heading -->
...
<h2 class="wp-block-heading has-extra-small-font-size"><?php esc_html_e('Filter by price', 'ishop');?></h2>
<!-- /wp:heading -->
...
<div class="wp-block-woocommerce-filter-wrapper"><!-- wp:heading {"fontSize":"extra-small"} -->
<h2 class="wp-block-heading has-extra-small-font-size"><?php esc_html_e('Filter by color', 'ishop');?></h2>
<!-- /wp:heading -->
