...
<!-- wp:post-content {"align":"full","style":{"spacing":{"padding":{"top":"var:preset|spacing|60","bottom":"var:preset|spacing|60"},"blockGap":"var:preset|spacing|40"}},"layout":{"type":"constrained","contentSize":""}} /-->
...
<h2 class="wp-block-heading"><?php esc_html_e('Comments', 'ishop');?></h2>
<!-- /wp:heading -->
