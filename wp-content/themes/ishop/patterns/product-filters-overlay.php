<?php
/**
 * Title: product-filters-overlay
 * Slug: ishop/product-filters-overlay
 * Categories: hidden
 * Inserter: no
 */
?>
<!-- wp:woocommerce/product-filters-overlay {"lock":{"move":true,"remove":true}} -->
<div class="wp-block-woocommerce-product-filters-overlay wc-block-product-filters-overlay"><!-- wp:woocommerce/product-filters {"lock":{"move":true,"remove":true}} -->
<div class="wp-block-woocommerce-product-filters wc-block-product-filters"><!-- wp:heading {"level":3,"lock":{"move":true,"remove":true},"style":{"typography":{"fontSize":"24px"}}} -->
<h3 class="wp-block-heading" style="font-size:24px"><?php esc_html_e('Filters', 'ishop');?></h3>
<!-- /wp:heading -->
...
<h3 class="wp-block-heading"><?php esc_html_e('Active', 'ishop');?></h3>
<!-- /wp:heading -->
...
<div class="wp-block-group"><!-- wp:heading {"level":3,"lock":{"move":true,"remove":true}} -->
<h3 class="wp-block-heading"><?php esc_html_e('Price', 'ishop');?></h3>
<!-- /wp:heading -->
...
<div class="wp-block-button wc-block-product-filter-clear-button is-style-outline" style="text-decoration:underline"><a class="wp-block-button__link wp-element-button" style="border-style:none;border-width:0px"><?php esc_html_e('Clear', 'ishop');?></a></div>
<!-- /wp:button --></div>
<!-- /wp:buttons -->
...
<!-- wp:group {"metadata":{"name":"Header"},"style":{"spacing":{"blockGap":"0"}},"layout":{"type":"flex","flexWrap":"nowrap"},"lock":{"move":true,"remove":true}} -->
<div class="wp-block-group"><!-- wp:heading {"level":3,"lock":{"move":true,"remove":true}} -->
<h3 class="wp-block-heading"><?php esc_html_e('Status', 'ishop');?></h3>
<!-- /wp:heading -->
...
<!-- wp:group {"metadata":{"name":"Header"},"style":{"spacing":{"blockGap":"0"}},"layout":{"type":"flex","flexWrap":"nowrap"},"lock":{"move":true,"remove":true}} -->
<div class="wp-block-group"><!-- wp:heading {"level":3,"lock":{"move":true,"remove":true}} -->
<h3 class="wp-block-heading"><?php esc_html_e('Color', 'ishop');?></h3>
<!-- /wp:heading -->
...
<!-- wp:group {"metadata":{"name":"Header"},"style":{"spacing":{"blockGap":"0"}},"layout":{"type":"flex","flexWrap":"nowrap"},"lock":{"move":true,"remove":true}} -->
<div class="wp-block-group"><!-- wp:heading {"level":3,"lock":{"move":true,"remove":true}} -->
<h3 class="wp-block-heading"><?php esc_html_e('Rating', 'ishop');?></h3>
<!-- /wp:heading -->
...
<!-- /wp:woocommerce/product-filter --></div>
