...
<div class="wp-block-group"><!-- wp:post-title {"isLink":true,"style":{"spacing":{"padding":{"top":"var:preset|spacing|30","bottom":"var:preset|spacing|30"}}},"fontSize":"medium"} /-->
...
<!-- wp:post-excerpt {"moreText":"Read more..","style":{"elements":{"link":{"color":{"text":"var:preset|color|vivid-green-cyan"},":hover":{"color":{"text":"var:preset|color|light-green-cyan"}}}}},"fontSize":"extra-small"} /--></div>
<!-- /wp:column --></div>
<!-- /wp:columns -->
...
<!-- wp:query-no-results -->
<!-- wp:paragraph -->
<p><?php esc_html_e('No results', 'ishop');?></p>
<!-- /wp:paragraph -->
<!-- /wp:query-no-results -->
