...
<div class="wp-block-group" style="padding-right:12px;padding-left:12px"><!-- wp:image {"id":283,"width":"100px","height":"100px","scale":"cover","sizeSlug":"full","linkDestination":"none","align":"center","className":"is-style-ishop-image-styletwo","style":{"border":{"radius":"0px"}}} -->
<figure class="wp-block-image aligncenter size-full is-resized has-custom-border is-style-ishop-image-styletwo"><img src="<?php echo esc_url( get_template_directory_uri() ); ?>/assets/images/people1.webp" alt="" class="wp-image-283" style="border-radius:0px;object-fit:cover;width:100px;height:100px"/></figure>
<!-- /wp:image -->
