...
<h1 class="wp-block-heading alignwide has-text-align-center woocommerce-coming-soon-banner has-inter-font-family"><?php esc_html_e('Pardon our dust! We\'re working on something amazing — check back soon!', 'ishop');?></h1>
<!-- /wp:heading --></div>
<!-- /wp:group --></main>
<!-- /wp:group -->
...
<p class="has-text-align-center has-contrast-2-color has-text-color has-link-color has-small-font-size"><?php esc_html_e('&nbsp;', 'ishop');?></p>
<!-- /wp:paragraph --></div>
<!-- /wp:group --></div>
<!-- /wp:group --></div>
<!-- /wp:group --></div></div>
